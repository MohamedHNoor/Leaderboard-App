...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_variables_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/variables.js */ \"./src/modules/variables.js\");\n/* harmony import */ var _modules_postData_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/postData.js */ \"./src/modules/postData.js\");\n/* harmony import */ var _modules_fetchData_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/fetchData.js */ \"./src/modules/fetchData.js\");\n\n\n\n\n\n\nconst displayList = async () => {\n  const data = await (0,_modules_fetchData_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n  const lists = data.result;\n  lists.forEach((item) => {\n    const li = document.createElement('li');\n    li.classList.add('score-list');\n    li.innerHTML = `<p>${item.user}: ${item.score}</p>`;\n    _modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.scoreLists.appendChild(li);\n  });\n};\n\n_modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.submitBtn.addEventListener('click', (e) => {\n  e.preventDefault();\n  (0,_modules_postData_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n});\n\ndocument.addEventListener('DOMContentLoaded', displayList);\n\nconst refresh = () => {\n  window.location.reload();\n};\n\n_modules_variables_js__WEBPACK_IMPORTED_MODULE_1__.refreshBtn.addEventListener('click', refresh);\n\n\n//# sourceURL=webpack://leaderboard-app/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _variables_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./variables.js */ \"./src/modules/variables.js\");\n\n\nconst fetchScore = async () => {\n  const data = await fetch(\n    `https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${_variables_js__WEBPACK_IMPORTED_MODULE_0__.gameID}/scores/`\n  );\n\n  const lists = await data.json();\n  return lists;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (fetchScore);\n\n\n//# sourceURL=webpack://leaderboard-app/./src/modules/fetchData.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _variables_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./variables.js */ \"./src/modules/variables.js\");\n\n\nconst postScore = async () => {\n  const response = await fetch(\n    `https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${_variables_js__WEBPACK_IMPORTED_MODULE_0__.gameID}/scores/`,\n    {\n      method: 'POST',\n      body: JSON.stringify({\n        user: _variables_js__WEBPACK_IMPORTED_MODULE_0__.input.value,\n        score: _variables_js__WEBPACK_IMPORTED_MODULE_0__.score.value\n      }),\n      headers: {\n        'Content-type': 'application/json'\n      }\n    }\n  );\n  await response.json();\n  _variables_js__WEBPACK_IMPORTED_MODULE_0__.input.value = '';\n  _variables_js__WEBPACK_IMPORTED_MODULE_0__.score.value = '';\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (postScore);\n\n\n//# sourceURL=webpack://leaderboard-app/./src/modules/postData.js?");
